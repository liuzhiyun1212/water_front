...
export default {
  ...
  data() {
    return {
      fileList: [
        // {name:"0014026921117105_b.jpg",url:"http://localhost:8080/profile/upload/2022/09/24/2053460_20220924182537A004.jpg"},
        // {name:"0014026921117105_a.jpg",url:"http://localhost:8080/profile/upload/2022/09/24/2053460_20220924182642A006.jpg"}
      ],
      dialogImageUrl: "",
      dialogVisible: false,
      loading: "",
  ...
  methods: {
    ...
    watchFiles(){
      if (this.message === '' || typeof (this.message) == 'undefined') {
        ...
        console.log("111",this.picList)
        console.log("afferentList",this.afferentList)
    },
    //时间戳格式化为yyyy/MM/dd
    formatDate2(d) {
      var date = new Date(d);
    ...
    handlePicRemove(file, picList) {
        console.log("显示列表", picList);
        console.log("返回列表1",this.uploadList);
        console.log("判断值",file.response);
        ...
        console.log("返回列表2",this.uploadList);
        this.returnData();
    },
    ...
    handlePictureCardPreview(file) {
      // console.log("本地地址", this.upload.imgUrl);
