...
<table class="table" style="margin-left:10%;width:70%;height:100%;border:1px solid;align:center;font-size:13px;" border cellspacing="0" cellpadding="9" >
      <caption style="font-size:24px;font-weight:bold;">拆除风险分析记录表</caption>
          <tr align="center" float="left">
            ...
            <td >评价项目</td>
            <td colspan="3"><input readonly v-model="detailData.evaluationProject"  class="myInput"/></td>
          </tr>
          <tr align="center" >
            <td >时 间</td>
            <td><input readonly v-model="detailData.projectTime" class="myInput"/></td>
            <td>评价人</td>
            <td><input  readonly v-model="detailData.evaluationPeople" class="myInput"/></td>
          </tr>
          <tr align="center">
          ...
          <tr align="left">
            <td>1、作业人员能力</td>
            <td colspan="3"><input readonly v-model="detailData.capacityOperator" class="myInput"/></td>
          </tr>
          <tr align="left">
            <td>2、作业设备</td>
            <td colspan="3"><input readonly v-model="detailData.operatingEquipment" class="myInput"/></td>
          </tr>
          <tr align="left">
            <td>3、安全防护</td>
            <td colspan="3"><input readonly v-model="detailData.safetyProtection" class="myInput"/></td>
          </tr>
          <tr>
            <td colspan="4"><div  readonly style="margin-left:10px;margin-top:5px">存在风险：
              <input  readonly v-model="detailData.risk" style="margin-bottom:10px;margin-top:8px" class="myInput"/></div>
            </td>
          </tr>
          <tr>
            <td colspan="4"><div style="margin-left:10px;margin-top:5px">采取的安全措施：
              <input readonly v-model="detailData.safetyMeasure" style="margin-bottom:10px;margin-top:8px" class="myInput"/></div>
            </td>
          </tr>
          <tr>
            <td colspan="4"><div style="margin-left:10px;margin-top:5px">评价简述：
              <input  readonly v-model="detailData.evaluationBrief" style="margin-bottom:10px;margin-top:8px" class="myInput"/></div>
            </td>
          <tr>
            <td colspan="4"><div style="margin-left:10px;margin-top:5px">评价结论：
              <input readonly v-model="detailData.evaluationConclusion" style="margin-bottom:10px;margin-top:8px" class="myInput"/></div>
            </td>
          <tr>
            <td colspan="4"><div style="margin-left:10px;margin-top:5px">备注：
              <input  readonly v-model="detailData.remarks" style="margin-bottom:10px;margin-top:8px" class="myInput"/></div>
            </td>
          </tr>
          <!-- <tr align="center">
            <td>提交人</td>
            <td><input readonly  v-model="detailData.submitter" class="myInput"/></td>
            <td>提交时间</td>
            <td><input  readonly v-model="detailData.submitTime" class="myInput"/></td>
          </tr>          -->
</table>
...
export default {
  ...
  methods: {
    ...
    // getList() {
    //   this.loading = true;
    //   getDemolitionAnalysis(this.$route.query.projectId).then(response => {
