    ...
    <el-container onload="setTime(),getTime();">
      <el-header>
        ...
        <div class="head" :style="headerHeight">
          ...
          <h1 style="margin-left: 20px; font-size: 22px; color: white; font-weight: 700; margin-top: 3px; background-color: rgba(0, 0, 0, 0);">设备全生命周期平台</h1>
        ...
        <el-row>
          <el-col :span="7" class="col-first">
            <el-card class="box-card" :style="rightHeight1">
              <equipmentGrade :height="rightHeight1.height"/>
            </el-card>
            <el-card class="box-card" :style="rightHeight2">
              <div class="a">
                <div style="color: white;">维保计划实施态势</div>
                <Gan :height="rightHeight2.height"/>
            ...
            <!-- <div class="a">
              ...
              <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
              <h1 style="font-size: large; color: white;"></h1></div> -->
          ...
          <el-col :span="10">
            ...
            <!-- < img src="../assets/map.jpg" style="width: 100%; height: 250px;"/> -->
          ...
          <el-col :span="7">
            <el-card class="box-card" :style="rightHeight1">
              <div class="a" style="">
                <div style="color: white;">设备故障预测</div>
                <Predict  style="cursor:pointer; " :height="rightHeight1Pic"/>
            ...
            <el-card class="box-card" :style="rightHeight2">
              <div style="color: white;">维保状态统计</div>
              <div id="relation" style="width: 100%;" :style="rightHeight2"></div>
              <!--                <firstTable style="height: 244px;"/>-->
...
import equipmentGrade from './life/equipmentGrade'
// 轮播
...
.nav>ul>li{
    ...
    box-sizing: border-box;
    border-radius: 5px;
    box-shadow: -10px 0px 15px #0c6a93 inset, /*å·¦è¾¹é˜´å½±*/
    0px -10px 15px #7f9aa4 inset; /*ä¸Šè¾¹é˜´å½±*/
...
<style>
.all{
  padding-left: 10px;height: 100%; padding-right: 10px;width: 100%;min-height: calc(100vh);
}
</style>
<!-- <template>
