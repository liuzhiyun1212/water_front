<template>
  <div class="all">
    <el-main class="main" style="margin-left: 20px;">
      ...
      <el-button type="primary" @click="toTheSystem(4)">图谱构建</el-button>
      <el-button type="primary" @click="toTheSystem(5)">图谱展示</el-button>
      <el-button type="primary" @click="toTheSystem(6)">图谱管理</el-button>
    </el-main>
    <el-card
      style="
        width: 95%;
    ...
    >
      <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
        ...
        <el-form-item>
          <el-button type="primary" icon="el-icon-search" size="mini" @click="toTheSystem(6)">搜索</el-button>
