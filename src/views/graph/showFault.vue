  ...
  <div>
    <div style="margin:10px;padding:20px;border-radius: 4px;border:2px;box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04)">
      <span style="margin: 20px">设备</span>
      <el-select v-model="devTypes" multiple placeholder="请选择">
        <el-option
      ...
      <span style="margin: 20px">现象</span>
      <el-select v-model="devTypes" multiple placeholder="请选择">
        <el-option
          v-for="item in graphOptions"
          :key="item.value"
      ...
      <span style="margin: 20px">故障</span>
      <el-select v-model="devTypes" multiple placeholder="请选择">
        <el-option
          v-for="item in graphOptions"
          :key="item.value"
      ...
      <span style="margin: 20px">修理</span>
      <el-select v-model="devTypes" multiple placeholder="请选择">
        <el-option
          v-for="item in graphOptions"
          :key="item.value"
...
<!--        <el-checkbox v-for="city in cities" v-model="checked1" label="备选项1" border></el-checkbox>-->
...
export default {
  data() {
    return {
      //按钮多选设备值
      checkboxGroup: ['故障中', '维修中', '完成维修', '报废'],
      //按钮多选数组
      cities : ['故障中', '维修中', '完成维修', '报废'],
      //多选设备值
      devTypes: '',
      //所有图谱列表
      graphList: [],
