<template>
  <div class="hello" onload="setTime(),getTime();">
    <el-container>
      <el-header>
        <!--头部-->
        <div class="head">
      ...
      <el-main>
        ...
        <el-row>
          <el-col :span="5" class="col-first">
          
            <el-card class="box-card">
              <div class="a">
                <h3 class="clearfix" style="font-size: 0.5em; ">设备数量变化</h3>
                <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
                <h1 style="font-size: 0.5em; color: white;"></h1>
                <div style="width: auto;height: 10rem" id="echart1">
                </div>
                <!-- <div style="width: auto;height: 10rem" id="first">
                </div> -->
              </div>
            </el-card>
            <el-card class="box-card">
              <div class="a">
                <h3 class="clearfix" style="font-size: 0.5em;">设备分析</h3>
                <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
                <h1 style="font-size: large; color: white;"></h1>
                  <div id="echart2" style="width: auto;height: 10rem;"></div>
                  <!-- <div id="OdfMes" style="width: 30rem;height: 10rem;float: right"></div> -->
              </div>
            </el-card>
            <el-card class="box-card">
              <div class="a">
                <h3 class="clearfix" style="font-size: 0.5em;">设备折线图</h3>
                <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
                <h1 style="font-size: large; color: white;"></h1>
                <div id="echart3" style="width:auto;height: 10rem;"></div>
              </div>
            </el-card>
          </el-col>
          <el-col :span="14">
            <el-card class="box-card">
              <div style="text-align: center;border-bottom: 10px; height: 2rem;font-size: 1.5em;">
                <h3 class="clearfix" style="font-size: 1em;">设备总数{{devSum}}</h3>
              </div>
              <el-col :span="8">
                    <div class="a">
                      <h3 class="clearfix" style="font-size: 1em;">采集器总数{{caiji}}</h3>
                      <div id="jindu" style="background-color: transparent; width: 5rem; height: 5rem;"></div>
                  </div>
              </el-col>
              <el-col :span="6">
                <h3 class="clearfix" style="font-size: 1em;">传感器总数{{sensor}}</h3>
                <div id="chuanjindu" style="background-color: transparent; width: 5rem; height: 5rem;"></div>     
                <!-- <div id="jindu" style="background-color: transparent; width: 5rem; height: 5rem;"></div> -->
              </el-col>
            ...
            <el-card  style="width: 100%; border: 0;margin: 0 auto;">
            <div id="chart_map" style="width:100%;height:610px;">地图</div>
              <div id="relation" style="width: 100%; height: 30rem;">
              </div>
              <!-- <div id="bingzhuangtu" style="width: 500px;height:400px;border:1px solid red;float: left;">hhh</div> -->
            </el-card>
          ...
          <el-col :span="5">
            <el-card class="box-card">
              <!-- <div class="info">
                    ...
                    <img src="../../assets/images/bj-1.png" alt="更多资源：https://gitee.com/iGaoWei/big-data-view" class="bj-1">
                    <img src="../../assets/images/bj-2.png" alt="更多资源：https://gitee.com/iGaoWei/big-data-view" class="bj-2">
                    <img src="../../assets/images/bj-3.png" alt="更多资源：https://gitee.com/iGaoWei/big-data-view" class="bj-3">
                    <img src="../../assets/images/bj-4.png" alt="更多资源：https://gitee.com/iGaoWei/big-data-view" class="bj-4">
                </div> -->
              <div class="a">
                <h3 class="clearfix" style="font-size: 0.5em;">设备利用率</h3>
                <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
                <h1 style="font-size: large; color: white;"></h1>
                <!-- <div class="report1">
                  <p>告警信息<br>100条</p>
                </div> -->
                <!-- <div class="chartsdom" id="chart_polo" style="width:50%;height:10rem;margin: 0 auto;"></div>  -->
                <!-- <div class="chartsdom" id="echart4" style="width:50%;height:10rem;margin: 0 auto;"></div>  -->
              </div>
            </el-card>
            <el-card class="box-card">
              <div class="a">
                <h3 class="clearfix" style="font-size: 0.5em;">生产厂家设备占比</h3>
                <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
                <h1 style="font-size: large; color: white;"></h1>
                <div style="width:100%;height:10rem" id="echart5">
                </div>
              </div>
            </el-card>
            <el-card class="box-card">
              <div class="a">
                <h3 class="clearfix" style="font-size: 0.5em;">设备利用率排行</h3>
                <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
                <h1 style="font-size: large; color: white;"></h1>
                <div style="width:100%;height:10rem" id="echart6"></div>
              </div>
            </el-card>
            <el-card class="box-card">
              <div class="a">
                <h3 class="clearfix" style="font-size: 0.5em;">设备维保信息</h3>
                <el-button style="float: right; padding: 3px 0; color: white;" type="text"></el-button>
                <h1 style="font-size: large; color: white;"></h1>
                <table class="t_table">
                        <thead>
...
        }],
    ...
    index: -1,
    index1:-1,
    color: ['#00ffff', '#006ced', '#ffe000', '#ffa800', '#ff5b00', '#ff3000'],
    // 知识图谱数据
    datas: [{
        name: '和润水务',
        symbolSize: 120,
    ...
    }, 
{
    ...
    getListDevSum(){
      listDevtable().then((res) => {
        this.devSum = res.rows.length;
        for(let i=0; i< res.rows.length; i++){
          if(res.rows[i].manufacturer === "易度传感"){
            this.yidu++;
          }else if(res.rows[i].manufacturer === "南方泵业"){
            this.nanfang++;
          }else if(res.rows[i].manufacturer === "ABB"){
            this.ABB++;
          }
        }
        this.upTimer();
  ...
  getRelation() {
          this.chPie = echarts.init(document.getElementById("relation"));
            for (var i = 0; i < this.yDataList.length; i++) {
              this.data.push({
                value: this.yDataList[i].value,
                name: ["已提交","审核中","维保中","验收中"],
                itemStyle: {
                  normal: {
                    borderWidth: 5,
                    shadowBlur: 20,
...
.report1 p{display: inline-block; font-weight: bold; font-size: 0.5em; color: #ff0000;margin-top: 50px;}
/* 维保信息表格 */
.t_table{
    font-size: 0.16rem;
    color: #fff;
